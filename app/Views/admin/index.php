    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h3 class="">
                                <!-- Sistem Keputusan Hasil Test Kemampuan Karyawan -->
                                <!-- Sistem Keputusan untuk meningkatkan pemahaman terkait IT Ruling pada seluruh karyawan Kaltim Methanol Industri -->
                                <!-- sistem keputusan untuk memberikan persoalan terkait IT Ruling pada seluruh karyawan PT. KMI -->
                                <!-- aplikasi berbasis web untuk mengetahui kemampuan karyawan terhadap dunia IT pada seluruh karyawan PT. KMI -->
                                <!-- aplikasi berbasis web untuk meningkatkan pemahaman IT Ruling pada seluruh karyawan PT. KMI -->
                                <!-- aplikasi berbasis web untuk memberikan soal terkait IT Ruling pada seluruh karyawan PT. KMI -->
                            </h3>
                        </div>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <center>
                            <img src="<?php echo base_url('img/pemkot-bontang.png'); ?>" width="120px" style="padding: 15px;">
        ...
        <footer class="main-footer d-flex justify-content-end align-items-center">
            ...
            <div class="float-right d-none d-sm-block ">
                <img class="justify-content-end" style="height: 30px;" src="<?= base_url() ?>/img/pemkot-bontang.png" alt="">
            </div>
        </footer>
